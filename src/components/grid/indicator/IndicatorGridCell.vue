<template>
  <button class="flex justify-center items-center enabled:hover:bg-base-300 rounded-full size-8 landscape:max-lg:size-6 md:size-10 touch-manipulation cursor-pointer disabled:pointer-events-none" :disabled="props.disabled || !hittable">
